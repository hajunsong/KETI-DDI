...
if __name__ == '__main__':
    ...
    # m_robot_master.move_pos_robot(move_pose, vel=velx, acc = accx, syncType=1)
    # time.sleep(1)
    # 
    # interval_pos = 100
    # interval_ori = 10
    ...
    #         # m_robot_master.move_pos_queue(move_list, vel=100, acc=200, syncType=1, time=5)
    #     elif key == 's':
    #         move_pose = [307.0, 100, 440.5, 35.434, -180, 35.434]
    #         m_robot_master.move_pos_robot(move_pose, vel= velx, acc = accx,  syncType=0, time=5)
    #     elif key == 'q':
    #         quit_flag = True
    #     elif key == ' ':
    ...
    # m_robot_master.move_pos_robot([707, 0, 440.478, 45, -180, 45], vel=20, acc=10, syncType = 1)
